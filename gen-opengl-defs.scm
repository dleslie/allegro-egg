...
(begin
  ...
  (define-constant gl:texture-rectangle-ext 34037)
  (define gl:texture-rectangle-ext gl:texture-rectangle-ext)
  (define-constant gl:texture-binding-rectangle-ext 34038)
  (define gl:texture-binding-rectangle-ext gl:texture-binding-rectangle-ext)
  (define-constant gl:proxy-texture-rectangle-ext 34039)
  (define gl:proxy-texture-rectangle-ext gl:proxy-texture-rectangle-ext)
  (define-constant gl:max-rectangle-texture-size-ext 34040)
  (define gl:max-rectangle-texture-size-ext gl:max-rectangle-texture-size-ext)
