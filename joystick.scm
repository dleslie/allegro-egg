(define joystick-addon-install (foreign-lambda bool "al_install_joystick"))
...
(define joystick-state-init! (foreign-lambda* void ((joystick-state state) (joystick j)) "al_get_joystick_state(j, state);"))
