...
(define bitmap-put-pixel! (foreign-lambda* void ((color c) (opaque_bitmap bmp) (int x) (int y)) "*c = al_get_pixel(bmp, x, y);"))
...
(define bitmap-put-pixel! (foreign-lambda* void ((opaque_bitmap bmp) (int x) (int y) (color c)) "
