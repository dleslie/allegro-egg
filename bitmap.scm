...
(define bitmap-draw (foreign-lambda void "al_draw_bitmap" bitmap float float blitting-flag))
(define draw-bitmap bitmap-draw)
(define bitmap-draw-region (foreign-lambda void "al_draw_bitmap_region" bitmap float float float float float float blitting-flag))
(define draw-bitmap-region bitmap-draw-region)
(define bitmap-draw-scaled (foreign-lambda void "al_draw_scaled_bitmap" bitmap float float float float float float float float blitting-flag))
(define draw-scaled-bitmap bitmap-draw-scaled)
(define bitmap-draw-rotated (foreign-lambda void "al_draw_rotated_bitmap" bitmap float float float float float blitting-flag))
(define draw-rotated-bitmap bitmap-draw-rotated)
(define bitmap-draw-scaled-rotated (foreign-lambda void "al_draw_scaled_rotated_bitmap" bitmap float float float float float float float blitting-flag))
(define draw-scaled-rotated-bitmap bitmap-draw-scaled-rotated)

(define bitmap-draw-tinted (foreign-lambda* void ((bitmap bmp) (color tint) (float dx) (float dy) (blitting-flag flags)) "al_draw_tinted_bitmap(bmp, *tint, dx, dy, flags);"))
(define draw-tinted-bitmap bitmap-draw-tinted)
(define bitmap-draw-tinted-region (foreign-lambda* void ((bitmap bmp) (color tint) (float sx) (float sy) (float sw) (float sh) (float dx) (float dy) (blitting-flag flags)) "al_draw_tinted_bitmap_region(bmp, *tint, sx, sy, sw, sh, dx, dy, flags);"))
(define draw-tinted-bitmap-region bitmap-draw-tinted-region)
(define bitmap-draw-tinted-scaled (foreign-lambda* void ((bitmap bmp) (color tint) (float sx) (float sy) (float sw) (float sh) (float dx) (float dy) (float dw) (float dh) (blitting-flag flags)) "al_draw_tinted_scaled_bitmap(bmp, *tint, sx, sy, sw, sh, dx, dy, dw, dh, flags);"))
(define draw-tinted-scaled-bitmap bitmap-draw-tinted-region)
(define bitmap-draw-tinted-rotated (foreign-lambda* void ((bitmap bmp) (color tint) (float cx) (float cy) (float dx) (float dy) (float angle) (blitting-flag flags)) "al_draw_tinted_rotated_bitmap(bmp, *tint, cx, cy, dx, dy, angle, flags);"))
...
(define bitmap-lock-region*! (foreign-lambda locked-region "al_lock_bitmap_region" bitmap int int int int pixel-format locking-flag))
