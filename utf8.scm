...
(define utf->string (foreign-lambda c-string "al_cstr" utf_string))
(define utf->buffer (foreign-lambda void "al_ustr_to_buffer" utf_string blob integer))
(define utf->string-copy (foreign-lambda c-string "al_cstr_dup" utf_string))
