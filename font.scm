...
(define font-utf-dimensions (foreign-primitive scheme-object (((const font) f) ((const utf-string) text)) "
int bbx, bby, bbw, bbh;
...
"))
(define font-dimensions (foreign-primitive scheme-object (((const font) f) ((const c-string) text)) "
int bbx, bby, bbw, bbh;
